...
> 当前仓库对应源码包版本：**v0.5.0，整理日期 2026-08-27**。
...
- 液态玻璃：静态模糊缓存、四边光影与微噪点，以及 KWin 实时模糊菜单/置顶智能空间。
...
2026-08-27 在 FTG340 / ARM64 / UKUI X11 上完成 Release 全量构建；玻璃样式、KWin Blur 协议、StackBlur、索引/知识库及新功能冒烟等 **7 项测试全部通过**。完整 CTest 共 10 项，另有 3 项既有桌面自动化/压力测试受隔离 DBus 会话、固定坐标窗口定位与 25,000 文件超时影响，详情见 [液态玻璃实施进度](01-ukui-fences-main-source/docs/LIQUID_GLASS_PROGRESS.md)。
